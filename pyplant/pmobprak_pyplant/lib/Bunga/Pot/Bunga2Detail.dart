...
class Bunga2Detail extends StatefulWidget {
  final String documentId;

  const Bunga2Detail({Key? key, required this.documentId})
      : super(key: key);

  @override
  _Bunga2Detail createState() =>
      _Bunga2Detail();
}

class _Bunga2Detail extends State<Bunga2Detail> {
  ...
  Future<DocumentSnapshot> _fetchBungaPotContent() async {
    try {
