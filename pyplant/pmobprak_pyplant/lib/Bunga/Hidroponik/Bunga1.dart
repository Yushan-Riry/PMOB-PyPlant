...
import 'package:pyplant/Bunga/Hidroponik/Bunga1Detail.dart'; // Import halaman detail

class Bunga1 extends StatefulWidget {
  const Bunga1({Key? key}) : super(key: key);

  @override
  _Bunga1State createState() => _Bunga1State();
}

class _Bunga1State extends State<Bunga1> {
  ...
  Future<List<DocumentSnapshot>> _fetchBungaHidroponikContent() async {
    try {
                ...
                return InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Bunga1Detail(documentId: document.id),
                      ),
                    );
                  },
                  child: Card(
