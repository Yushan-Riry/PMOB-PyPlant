...
class Buah3Detail extends StatefulWidget {
  final String documentId;

  const Buah3Detail({Key? key, required this.documentId})
      : super(key: key);

  @override
  _Buah3Detail createState() =>
      _Buah3Detail();
}

class _Buah3Detail extends State<Buah3Detail> {
  ...
  Future<DocumentSnapshot> _fetchBuahTanahContent() async {
    try {
