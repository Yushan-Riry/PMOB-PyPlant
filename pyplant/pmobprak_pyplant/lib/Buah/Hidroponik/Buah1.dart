...
import 'package:pyplant/Buah/Hidroponik/Buah1Detail.dart'; // Import halaman detail

class Buah1 extends StatefulWidget {
  const Buah1({Key? key}) : super(key: key);

  @override
  _Buah1State createState() => _Buah1State();
}

class _Buah1State extends State<Buah1> {
  late Future<List<DocumentSnapshot>> _fetchContent;

  @override
  void initState() {
    super.initState();
    _fetchContent = _fetchBuahHidroponikContent();
  }

  Future<List<DocumentSnapshot>> _fetchBuahHidroponikContent() async {
    try {
                ...
                return InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Buah1Detail(documentId: document.id),
                      ),
                    );
                  },
                  child: Card(
