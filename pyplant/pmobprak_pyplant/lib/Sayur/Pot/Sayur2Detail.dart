...
class Sayur2Detail extends StatefulWidget {
  final String documentId;

  const Sayur2Detail({Key? key, required this.documentId})
      : super(key: key);

  @override
  _Sayur2Detail createState() =>
      _Sayur2Detail();
}

class _Sayur2Detail extends State<Sayur2Detail> {
  ...
  Future<DocumentSnapshot> _fetchSayurPotContent() async {
    try {
