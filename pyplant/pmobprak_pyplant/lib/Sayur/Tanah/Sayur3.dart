...
import 'package:pyplant/Sayur/Tanah/Sayur3Detail.dart'; // Import halaman detail

class Sayur3 extends StatefulWidget {
  const Sayur3({Key? key}) : super(key: key);

  @override
  _Sayur3State createState() => _Sayur3State();
}

class _Sayur3State extends State<Sayur3> {
  late Future<List<DocumentSnapshot>> _fetchContent;

  @override
  void initState() {
    super.initState();
    _fetchContent = _fetchSayurTanahContent();
  }

  Future<List<DocumentSnapshot>> _fetchSayurTanahContent() async {
    try {
                ...
                return InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Sayur3Detail(documentId: document.id),
                      ),
                    );
                  },
                  child: Card(
