...
import 'package:pyplant/Sayur/Hidroponik/Sayur1Detail.dart'; // Import halaman detail

class Sayur1 extends StatefulWidget {
  const Sayur1({Key? key}) : super(key: key);

  @override
  _Sayur1State createState() => _Sayur1State();
}
...
class _Sayur1State extends State<Sayur1> {
  ...
  Future<List<DocumentSnapshot>> _fetchSayurHidroponikContent() async {
    try {
                ...
                return InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Sayur1Detail(documentId: document.id),
                      ),
                    );
                  },
                  child: Card(
